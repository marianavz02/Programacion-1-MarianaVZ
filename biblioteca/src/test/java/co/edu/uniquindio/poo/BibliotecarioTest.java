...
public class BibliotecarioTest {
    ...
    public void testDatosCompletos() {
        ...
        Bibliotecario bibliotecario = new Bibliotecario("Gabriel", "10924555", "314366", "Gabrielyisus@email.com", false,
                true);
    ...
    public void testDatosNulos() {
        ...
        assertThrows(Throwable.class, () -> new Bibliotecario(null, null, null, null, true, false));
